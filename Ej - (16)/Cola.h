...
void Cola<T>::invertir() {
        ...
        tope = anterior;
        // Nota: No necesitamos actualizar 'final' ya que los punteros se invierten y
        // el nodo que era anteriormente el último ahora es el primero.
        imprimir();
}

template<class T>
void Cola<T>::sumarANumeroEnPosicion() {
    T n;
